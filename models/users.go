...
type userR struct {
	...
	UpdatedByUsers UserSlice `boil:"UpdatedByUsers" json:"UpdatedByUsers" toml:"UpdatedByUsers" yaml:"UpdatedByUsers"`
}
...
var (
	userAllColumns            = []string{"id", "user_name", "password_hash", "created_at", "created_by", "updated_at", "updated_by"}
	userColumnsWithoutDefault = []string{"user_name", "password_hash", "created_by", "updated_by"}
...
func (o *User) UpdatedByUser(mods ...qm.QueryMod) userQuery {
	queryMods := []qm.QueryMod{
...
// UpdatedByUsers retrieves all the user's Users with an executor via updated_by column.
func (o *User) UpdatedByUsers(mods ...qm.QueryMod) userQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"users\".\"updated_by\"=?", o.ID),
	)
...
// loaded structs of the objects. This is for an N-1 relationship.
func (userL) LoadUpdatedByUser(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
...
func (userL) LoadCreatedByUsers(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`users`),
		qm.WhereIn(`users.created_by in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (userL) LoadUpdatedByUsers(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`users`),
		qm.WhereIn(`users.updated_by in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// SetUpdatedByUser of the user to the related item.
// Sets o.R.UpdatedByUser to related.
// Adds o to related.R.UpdatedByUsers.
func (o *User) SetUpdatedByUser(ctx context.Context, exec boil.ContextExecutor, insert bool, related *User) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
...
// Removes o from all passed in related items' relationships struct (Optional).
func (o *User) RemoveUpdatedByUser(ctx context.Context, exec boil.ContextExecutor, related *User) error {
	var err error
...
// user replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.UpdatedByUser's UpdatedByUsers accordingly.
// Replaces o.R.UpdatedByUsers with related.
// Sets related.R.UpdatedByUser's UpdatedByUsers accordingly.
func (o *User) SetUpdatedByUsers(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*User) error {
	query := "update \"users\" set \"updated_by\" = null where \"updated_by\" = $1"
	values := []interface{}{o.ID}
	if boil.IsDebug(ctx) {
		writer := boil.DebugWriterFrom(ctx)
		fmt.Fprintln(writer, query)
